...
char *my_substr(const char *s, unsigned int start, size_t len)
{
    size_t i;
    char *str;
...
int test0()
{
    ...
    unsigned int    len = 8;
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "str : [%s] | start : [%u] | len : [%u]\n" RESET, test_a, start, len);
	char *res = my_substr(test_a, start, len);
	printf("[+] WATH SHOULD WE GET :");
	printf(HEAVENLY " %s\n" RESET, res);
	char *y_res = ft_substr(test_a, start, len); 
...
int test1()
{
	...
	char test_a[100] = "and what about this one!!";
...
int test5()
{
	...
	char test_a[100] = "ft_substr returns a substring of the string s passed as parameter";
    unsigned int    start = strlen(test_a) - 28;
    unsigned int    len = 30;
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "str : [%s] | start : [%u] | len : [%u]\n" RESET, test_a, start, len);
	char *res = my_substr(test_a, start, len);
...
int test6()
{
    ...
    unsigned int    len = strlen(test_a);
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "str : [%s] | start : [%u] | len : [%u]\n" RESET, test_a, start, len);
	char *res = my_substr(test_a, start, len);
	printf("[+] WATH SHOULD WE GET :");
...
int test11()
{
	...
	char test_a[100] = "My time has come!!";
