...
int test0()
{
	...
	int res = memcmp(test_a, test_b, n) ;
	printf("[+] WATH SHOULD WE GET :");
	printf(HEAVENLY " %d\n" RESET, res);
	int y_res = ft_memcmp(test_a, test_b, n); 
...
int test4()
{
	...
	char test_a[100] = {-1,10,5,1};
	char test_b[100] = {-1,10,5,0};
	unsigned int n = 10;
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "n1 : [{-1,10,5,1}]  | n2 : [{-1.10.5.0}] | n : [%d]\n" RESET, n);
	int res = memcmp(test_a, test_b, n);
	printf("[+] WATH SHOULD WE GET :");
	printf(HEAVENLY " %d\n" RESET, res);
	int y_res = ft_memcmp(test_a, test_b, n);
...
int test5()
{
	...
	char test_a[100] = "123\x0,123\x0\0";
	char test_b[100] = "123\x0,123\x0\0";
	unsigned int n = sizeof(test_b);
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "s1 : [123\\x0,123\\x0\\0]  | s2 : [123\\x0,123\\x0\\0] | n : [%d]\n" RESET, n);
	int res = memcmp(test_a, test_b, n);
	printf("[+] WATH SHOULD WE GET :");
	printf(HEAVENLY " %d\n" RESET, res);
	int y_res = ft_memcmp(test_a, test_b, n);
...
int test6()
{
	...
	char test_b[100] = "good work bro !!";
	unsigned int n = sizeof(test_a);
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "s1 : [%s]  | s2 : [%s] | n : [%d]\n" RESET, test_a, test_b, n);
	int res = memcmp(test_a, test_b, n);
	printf("[+] WATH SHOULD WE GET :");
...
int test7()
{
	...
	char test_a[100] = "hi good\x4programmer";
