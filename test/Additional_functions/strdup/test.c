...
int test0()
{
	...
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "str : [%s]\n" RESET, test_a);
	char *res = strdup(test_a);
	printf("[+] WATH SHOULD WE GET :");
	printf(HEAVENLY " %s\n" RESET, res);
	char *y_res = ft_strdup(test_a); 
...
int test5()
{
	...
	char test_a[100] = "111111111111111111111111111111111111111111111111111111111111111111!!";
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY "str : [%s]\n" RESET, test_a);
	char *res = strdup(test_a);
	printf("[+] WATH SHOULD WE GET :");
