...
int test0()
{
	...
	char *test = "12fqdsfdq34";
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY " %s\n" RESET, test);
	int res = strlen(test) ;
	printf("[+] WATH SHOULD WE GET :");
	printf(HEAVENLY " %d\n" RESET, res);
	int y_res = ft_strlen(test); 
...
int test4()
{
	...
	char *test = "THE TEST [ NOT PASS ] ╭(╥_╥)╮ TRY AGINE AND GOOD LUCK !!";
	printf("[+] WATH WE HAVE :"); 
	printf(HEAVENLY " %s\n" RESET, test);
	int res = strlen(test);
	printf("[+] WATH SHOULD WE GET :");
